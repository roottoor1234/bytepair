        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li key={index} className="hover:text-orange-500 transition-colors cursor-default">{service}</li>
              ))}
            </ul>
            </div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li key={index} className="hover:text-orange-500 transition-colors cursor-default">{link}</li>
              ))}
            </ul>
            </div>
